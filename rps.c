...
void play(){
    ...
    int value = rand() % (3);                                                   //Generates computers choice: 0 for rock, 1 for paper, or 2 for scissors
    if(value == 0){                                                             //Computers choice is rock
    ...
    }else if(value == 1){                                                       //Computers choice is paper
        if(strcmp(input, "rock")==0){                                           //Users choice is rock
    ...
    }else if(value == 2){                                                       //Computers choice is scissors
        if(strcmp(input, "rock") == 0){                                         //Users choice is rock
